      ...
      <section class="contact">
        <div class="row">
            ...
            <form action="" method="post">
                ...
                <button type="submit" class="inline-btn"><i class="fa-solid fa-envelope"></i> Send message</button>
            </form>
        </div>
        <div class="box-container">
            <div class="box">
                ...
                <h3>phone number</h3>
                <a href="tel:+261321512281">+261321512281</a>
                <a href="tel:+261339255313">+261339255313</a>
                <a href="tel:+261342437638">+261342437638</a>
            </div>
            
            <div class="box">
                <i class="fa-solid fa-envelope"></i>
                <h3>E-mail</h3>
                <a href="mailto:asdonsoter@gmail.com">asdonsoter@gmail.com</a>
            </div>
            <div class="box">
                <i class="fa-solid fa-map-marker-alt"></i>
                <h3>location</h3>
                <a href="#">lot 17A184 Ivory Cristal, Antsirabe, Vakinankaratra</a>
            </div>
