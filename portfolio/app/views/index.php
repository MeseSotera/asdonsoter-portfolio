<?php $this->load_view("header",$data); ?>
     ...
     <section class="banner">
        <div class="sliders">
            <div class="slide">
                ...
                <div class="flex-btn">
                    <a href="details.html" class="btn" style="background-color: #00000017;color:var(--black);font-weight:bold;font-size:3rem;">Code. Connect. Legislate.</a>
                </div>
            </div>
            ...
            <div class="slide">
                ...
                <div class="flex-btn">
                    <a href="details.html" class="btn" style="background-color: #00000017;color:var(--black);font-weight:bold;font-size:3rem;">Building the Future, One Algorithm & Law at a Time.</a>
                </div>
            </div>
            <div class="slide">
                <img src="<?=ASSETS?>front/images/slider/slide-2.jpg" alt="">
                <div class="flex-btn">
                    <a href="details.html" class="btn" style="background-color: #00000017;color:var(--black);font-weight:bold;font-size:3rem;">Where Full Stack Meets Public Policy.</a>
                </div>
            </div>
            <div class="slide">
                <img src="<?=ASSETS?>front/images/slider/slide-3.jpg" alt="">
                <div class="flex-btn">
                    <a href="details.html" class="btn" style="background-color: #00000017;color:var(--black);font-weight:bold;font-size:3rem;">Engineer by Code, Advocate by Law.</a>
                </div>
            </div>
            <div class="slide">
                <img src="<?=ASSETS?>front/images/slider/slide-4.png" alt="">
                <div class="flex-btn">
                    <a href="details.html" class="btn" style="background-color: #00000017;color:var(--black);font-weight:bold;font-size:3rem;">Debugging Systems, Designing Solutions, Shaping Policies.</a>
                </div>
            </div>
    ...
    <!-- quick option section start -->
     <section class="quick-select">
        <h1 class="heading">What I do & Technologies I use?</h1>
            ...
            <div class="box">
                ...
                <div class="flex">
                    <div class="slide-1">
                        ...
                        <a href="#"><i class="fab fa-docker"></i><span>Docker</span></a>
                    </div>
                </div>
            </div>
        </div>
